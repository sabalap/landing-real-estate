...
const Testimonials = () => {
  return (
    <section className="bg-[#EFEDEB] h-[57.5rem] relative">
      <div className="w-[97.5rem] mx-auto h-full">
        <div className="flex h-full">
          <div className="border-r border-[#cccccc] w-[30rem]">
            <h1 className="pt-20 mb-12 w-[20.875rem] font-medium text-[3.5rem] leading-[4.75rem] text-black">
              Clutch Testimonials
            </h1>
          ...
          <div className="h-[46rem] flex flex-col">
            <div className="flex">
              <div className="bg-white p-10 rounded-2xl border w-[30rem] ml-[3.75rem] mt-20 h-[24.25rem] border-[#cccccc]">
                <h3 className="font-bold text-2xl leading-9 text-black mb-10">
              ...
              <div className="bg-white p-10 rounded-2xl border w-[30.15rem] ml-[3.75rem] mt-20 h-[31rem] border-[#cccccc]">
                <h3 className="font-bold text-2xl leading-9 text-black mb-10">
                  “Real estate is home to dreamers, designers, and builders. For
                  an industry that is all about vision, augmented reality can
            ...
            <div className="h-[11.5rem] border-t border-[#cccccc] w-[78.75rem] absolute bottom-0">
              <div className="h-full w-[67.6495rem] flex items-center justify-between">
                <div>
                  <span className="absolute top-[50%] left-[3.75rem] w-28 bg-black h-[0.1875rem]"></span>
                  <span className="absolute top-[50.6%] left-[10.75rem] w-[30rem] bg-[#CCCCCC] h-[0.0625rem]"></span>
                </div>
